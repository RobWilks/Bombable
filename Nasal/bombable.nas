...
)
{
	...
	if (targetSize_m == nil or targetSize_m.horz <= 0 or targetSize_m.vert <= 0 or thisWeapon.maxDamageDistance_m <= 0) 
	{
	...
	var maxTurn_rad = delta_t * thisWeapon.rateOfTurn_degps * D2R; 
